...
export const STEPS = [
	...
	{ target: null, title: "The one rule",
	  text: "Cells pulse into the cells beside them. Each extra neighbour adds to a cell's power - but multiplies its heat. Two cells side by side make twice the power and far more than twice the heat. Packing cells together is how you get rich, and how you melt down. Everything else in this game exists to make room for that." },
	{ target: ".meter.power", title: "Selling power",
