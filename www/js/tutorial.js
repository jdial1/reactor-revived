...
export const STEPS = [
	...
	{ target: "#dock-tabs", title: "Moving heat around",
	  text: "Later - a Transfer tab opens when the log gets there. Transfer parts move heat without destroying it. A Heat Exchanger evens heat out between itself and its neighbours, pulling from whatever is fuller. An Inlet pulls heat out of the parts beside it into the reactor's shared pool. An Outlet pushes heat from that pool into the parts beside it - ideally vents." },
	...
	{ target: "#dock-tabs", title: "More power",
	  text: "Later - a Power tab opens when the log asks for a capacitor. A Capacitor raises the maximum power the bar can hold, so less is wasted between sells. A Reflector sits beside cells and makes them produce more, but wears out as they pulse into it." },
